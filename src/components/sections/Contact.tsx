...
export const Contact: React.FC = () => {
  return (
    <section
      id="contato"
      className="py-20 lg:py-28 bg-gradient-to-br from-primary-900 to-primary-800 dark:from-primary-950 dark:to-primary-900 relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="text-white">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Sua próxima contratação de sucesso está a{' '}
              <span className="text-blue-300">um clique</span> de distância.
            </h2>
            <p className="text-primary-100 dark:text-primary-200 text-lg mb-8 leading-relaxed max-w-xl">
              Não perca mais tempo com processos seletivos manuais. Junte-se a mais de 500 empresas
              de Maricá que modernizaram seu RH. Publique agora e comece a entrevistar amanhã.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <span className="flex items-center relative z-10">
                  ...
                  <ArrowRight
                    className="ml-3 w-6 h-6 group-hover:translate-x-1.5 transition-transform duration-300"
                    strokeWidth={3}
                  />
                </span>
              </Button>
