...
export const loginCandidatoSchema = z.object({
  identificador: z.string().min(1, 'Informe seu email, CPF ou celular'),
  senha: z.string().min(1, 'Informe sua senha'),
})

export const loginEmpresaSchema = z.object({
  identificador: z.string().min(1, 'Informe seu CNPJ ou email'),
  senha: z.string().min(1, 'Informe sua senha'),
})

export const cadastroCandidatoSchema = z
  .object({
    cpf: z
      .string()
    ...
    distrito: z.string().min(1, 'Selecione seu distrito'),
    celular: z
      .string()
