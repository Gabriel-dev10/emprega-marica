...
export const Contact: React.FC = () => {
  return (
    <section id="contato" className="py-20 lg:py-28 bg-gradient-to-br from-primary-900 to-primary-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-primary-100 text-lg mb-8 leading-relaxed max-w-xl">
            ...
            <p className="mt-6 text-sm text-primary-300 opacity-80 pl-2">
          ...
          <div className="relative hidden lg:block">
             {/* Card Principal */}
            <div className="relative z-10 bg-white rounded-2xl p-6 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500 border border-white/10 w-96 mx-auto">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-xs font-semibold text-green-600 bg-green-50 px-2 py-1 rounded-md flex items-center">
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  <h4 className="text-lg font-bold text-neutral-900">Mariana Costa</h4>
                  <p className="text-sm text-neutral-500">Gerente Comercial</p>
                  <p className="text-xs text-primary-600 font-medium mt-1">Mora em: Itaipuaçu (3km)</p>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between text-xs text-neutral-500">
                  ...
                  <span className="font-bold text-neutral-900">8 Anos</span>
                </div>
                <div className="h-2 bg-neutral-100 rounded-full overflow-hidden">
                 ...
                 <div className="flex justify-between text-xs text-neutral-500">
                  ...
                  <span className="font-bold text-neutral-900">Imediata</span>
                </div>
              </div>
            ...
            {/* Badge Flutuante */}
            <div className="absolute -bottom-6 right-10 bg-white p-4 rounded-xl shadow-xl flex items-center space-x-3 z-20 animate-bounce-slow">
               <div className="bg-green-100 p-2 rounded-lg text-green-600">
                 <Search size={20} />
               </div>
               <div>
                 <p className="text-xs text-neutral-500 uppercase font-bold tracking-wider">Nova Busca</p>
                 <p className="text-sm font-bold text-neutral-900">5 novos candidatos hoje</p>
               </div>
            </div>
          </div>
