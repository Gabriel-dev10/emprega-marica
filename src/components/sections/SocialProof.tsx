        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary-200 dark:text-primary-300">Gestor de Clínica no Centro</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-xl p-6 text-center border border-white/10 dark:border-white/5">
              ...
              <div className="text-sm text-primary-200 dark:text-primary-300">Empresas Cadastradas</div>
            </div>
            <div className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-xl p-6 text-center border border-white/10 dark:border-white/5">
              <div className="text-4xl font-bold text-white mb-2">3 Dias</div>
              <div className="text-sm text-primary-200 dark:text-primary-300">Tempo Médio de Contratação</div>
            </div>
            <div className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-xl p-6 text-center border border-white/10 dark:border-white/5">
