...
import {
  type LoginCandidatoForm as LoginCandidatoFormData,
  type LoginEmpresaForm as LoginEmpresaFormData,
...
function LoginCandidatoForm() {
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<LoginCandidatoFormData>({
    resolver: zodResolver(loginCandidatoSchema),
  })

  const onSubmit = (data: LoginCandidatoFormData) => {
...
function LoginEmpresaForm() {
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<LoginEmpresaFormData>({
    resolver: zodResolver(loginEmpresaSchema),
  })

  const onSubmit = (data: LoginEmpresaFormData) => {
