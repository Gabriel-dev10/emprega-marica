        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-neutral-400 dark:text-neutral-500 text-sm leading-relaxed mb-6">
              Conectando empresas e talentos de Maricá para fortalecer nossa economia local e gerar oportunidades reais.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-neutral-400 dark:text-neutral-500 hover:text-white transition-colors"><Linkedin size={20} /></a>
              <a href="#" className="text-neutral-400 dark:text-neutral-500 hover:text-white transition-colors"><Instagram size={20} /></a>
              <a href="#" className="text-neutral-400 dark:text-neutral-500 hover:text-white transition-colors"><Facebook size={20} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-400 dark:text-neutral-500">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Para Candidatos</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Planos e Preços</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Aceitamos Mumbuca</a></li>
            </ul>
          </div>
