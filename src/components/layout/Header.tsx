...
export const Header: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <span className={`text-2xl font-bold tracking-tight ${isScrolled || isMobileMenuOpen ? 'text-primary-600' : 'text-primary-800'}`}>
              EmpregaAí<span className="text-neutral-600">Maricá</span>
            </span>
          </div>
      ...
      {/* Mobile Nav */}
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-neutral-100 shadow-lg animate-fade-in">
          <div className="px-4 py-6 space-y-4 flex flex-col">
            {navLinks.map((link) => (
              <a 
                ...
                className="text-neutral-600 hover:text-primary-600 font-medium py-2 text-lg"
              >
                {link.name}
              </a>
            ))}
